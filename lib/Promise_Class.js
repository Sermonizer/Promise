/*
 * @Author: your name
 * @Date: 2020-07-10 09:54:02
 * @LastEditTime: 2020-07-29 16:36:34
 * @LastEditors: Please set LastEditors
 * @Description: Promise ES6的类实现
 * @FilePath: \Promise\lib\Promise_Class.js
 */
  ...
  class Promise {
    ...
    then = function (onFulfilled, onRejected) {
      ...
      return new Promise((resolve, reject) => {
        ...
        // 判断当前Pormise的状态
        if (_this.status === PENDING) {
          // Promise当前状态是pending，先将回调函数保存起来，异步执行onFulfilled并改变return的promise状态
